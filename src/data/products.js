...
export const products = [
...

  {
    ...
    title: 'Commercial Bounce Houses from Henan, China to Ireland | Ériu Sourcing',
    description: 'Source commercial-grade bounce houses, castles and obstacle courses direct from Zhengzhou-Xinxiang Henan factories. EN 14960 compliant. 40–60% under UK event-hire trade pricing.',
...

  {
    ...
    categoryFullSlug: 'commercial-inflatables-from-china-ireland',
    categoryLabel: 'Commercial Inflatables',
    title: 'Inflatable Water Parks from Henan, China to Ireland | Ériu Sourcing',
    description: 'Source modular floating inflatable water park installations direct from Henan, China — for Irish holiday parks, lake-based attractions, and commercial leisure operators. EN-compliant. 45–55% under UK trade.',
