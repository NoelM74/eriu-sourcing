...
export const products = [
...

  {
    ...
    categoryFullSlug: 'construction-materials-from-china-ireland',
    categoryLabel: 'Construction Materials',
    title: 'Commercial LED Lighting from Zhongshan to Ireland | Ériu Sourcing',
    ...
    h1: 'Commercial LED lighting — factory-direct from Guzhen, Zhongshan to Ireland',
...

  {
    ...
    categoryFullSlug: 'construction-materials-from-china-ireland',
    categoryLabel: 'Construction Materials',
    title: 'Sanitaryware from Foshan to Ireland — WCs, Basins, Showers | Ériu Sourcing',
    ...
    h1: 'Sanitaryware — WCs, basins, baths, showers, factory-direct from Foshan to Ireland',
...

  {
    ...
    h1: 'Construction fasteners and fixings — factory-direct from Hebei to Ireland',
