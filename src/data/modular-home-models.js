...
export const modularHomeModels = [
  {
    ...
    metaDescription: 'The 20ft expandable container home from Ériu — folds to 2.2 m for shipping, expands to 6.3 m on site, ~34 m² internal. Compact back-garden auxiliary dwelling fully compliant with Irish building regs.',
...

  {
    ...
    metaDescription: 'The 30ft expandable container home from Ériu — ~52 m² internal, comfortable 2-bedroom layout. The mid-size step up from the 20ft, ideal for larger auxiliary dwellings, holiday lets and modular rural housing.',
...

  {
    ...
    metaDescription: 'The 40ft expandable container home from Ériu — ~70 m² internal, 2 or 3-bedroom family layout. The full-size modular home shipped factory-direct from central China to Ireland.',
...

  {
    ...
    metaDescription: 'The 20FT700 foldable modular cabin from Ériu — folds to just 700 mm wide so six units load to a single 40HQ container. The shipping-efficiency model for multi-unit projects, holiday parks and site accommodation.',
